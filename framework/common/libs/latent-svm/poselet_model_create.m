function m = poselet_model_create(cls, note)
...
global config, LIB_DIR;

if isempty(config)
    poselet_detection_config;
    load(fullfile(LIB_DIR, 'latent-svm-poselets', 'poselets_model_sep09.mat'));
    m.svms = model.svms;
end
