function p = paths()
    ...
    p = {fullfile(root, 'myAlgo') ...
         fullfile(root, 'baseline') ...
         fullfile(root, 'feifei') ...
         fullfile(root, 'BMVC') ...
         ...
         fullfile(root, 'common', 'matlab', 'misc', 'VOCtoolkit') ...  
         fullfile(root, 'common', 'matlab', 'misc', 'DB') ...    
         ...
         fullfile(root, 'common', 'libs', 'my_Image_Toolbox') ... 
